...
<head>
    ...
    <meta name="keywords" content="Smart Touch Solutions" />
    <meta name="description" content="Best Information Technology Company and Software Development Company" />
    <meta name="author" content="smart touch solutions" />
...
<body>
    ...
    <header class="header valign bg-img" data-scroll-index="0" data-overlay-dark="7"
        data-background="{{ asset('assets/img/bg3.jpg') }}" data-stellar-background-ratio="0.5">
                            ...
                            <div class="row">
                                <div class="left col-lg-6">
                                    <div class="mission box-white">
                                        ...
                                        <h6 class="sub-title">We Are A Creative Agency</h6>
                                        <p class="mb-10"><b>We’re full service which means</b> we’ve got you
                                            covered on design and content right through to digital. You’ll form a
                                            lasting relationship with us, <b>collaboration is central to</b> everything
                                            we do. <b>We’ll push you out of</b> your comfort zone from time, but this is
                                            where you’ll shine. Bottom line is we want you to succeed at Faculty.</p>
    ...
    <div class="process section-padding bg-img bg-fixed pos-re text-center" data-overlay-dark="7"
        data-background="{{ asset('assets/img/bg6.jpg') }}">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item first mb-md50">
                        <img src="{{ asset('assets/img/arrow.png') }}" class="tobotm" alt="">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="gallery full-width">
                    ...
                    <div class="col-lg-3 col-md-6 items brand">
                        <div class="item-img">
                            <img src="{{ asset('assets/img/portfolio/7.jpg') }}" alt="image">
                            <div class="item-img-overlay">
                                <div class="overlay-info full-width">
                                    <p>Logo | Branding</p>
                                    <h6>Creative Web Design</h6>
                                    <a href="{{ asset('assets/img/portfolio/7.jpg') }}" class="popimg">
                                        <span class="icon"><i
                                                class="fas fa-long-arrow-alt-right"></i></span>
                                    </a>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 items graphic">
                        <div class="item-img">
                            <img src="{{ asset('assets/img/portfolio/8.jpg') }}" alt="image">
                            <div class="item-img-overlay">
                                <div class="overlay-info full-width">
                                    <p>Logo | Branding</p>
                                    <h6>Creative Web Design</h6>
                                    <a href="{{ asset('assets/img/portfolio/8.jpg') }}" class="popimg">
                                        <span class="icon"><i
                                                class="fas fa-long-arrow-alt-right"></i></span>
                                    </a>
                                </div>
    ...
    <section class="testimonials section-padding bg-img bg-fixed pos-re" data-overlay-dark="7"
        data-background="{{ asset('assets/img/bg4.jpg') }}">
        <div class="container">
            <div class="row">
                ...
                <div class="owl-carousel owl-theme text-center col-lg-10 offset-lg-1">
                    <div class="item-box">
                        <span class="quote">
                            <img src="{{ asset('assets/img/quot.png') }}" alt="">
                        </span>
                    ...
                    <div class="item-box">
                        ...
                        <div class="info">
                            <div class="author-img">
                                <img src="{{ asset('assets/img/clients/4.jpg') }}" alt="">
                            </div>
                            <div class="cont">
                                <h6>Alex Smith</h6>
                                <span>Envato Customer</span>
    ...
    <section class="call-action section-padding bg-img bg-fixed" data-overlay-dark="5"
        data-background="{{ asset('assets/img/bg2.jpg') }}">
        <div class="container">
            <div class="row">
    ...
    <footer class="text-center pos-re">
        <div class="container">
            ...
            <p><a target="_blank" href="http://smarttouchsolutions.in">Smart Touch Solutions</a></p>
        </div>
